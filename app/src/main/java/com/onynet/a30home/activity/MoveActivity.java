...
import com.onynet.a30home.adapter.MoveListItemAdapter;
...
public class MoveActivity extends BaseActivity {
    ...
    private MoveListItemAdapter adapter;
    ...
    private void initData() {
        ...
        adapter = new MoveListItemAdapter(this, packageModels);
    ...
    private void setListener() {
        ...
        adapter.setOnMovePackageListener(new MoveListItemAdapter.OnMovePackageListener() {
            @Override
...
//                initTextToSpeech();
    ...
    protected String setVoicePrompt() {
        return getString(R.string.move_success);
    }
    ...
    private void initView() {
        ...
        toolbarTvTitle.setText(R.string.package_move);
...
//                startActivityForResult(intent, REQUEST_IMAGE);
            ...
            case R.id.toolbar_btn_menu:
                startActivity(new Intent(MoveActivity.this,AboutUsActivity.class)
                        .putExtra("url",ApiConfig.MOVE_HELP)
                        .putExtra("title",getString(R.string.explain)));
                break;
        }
    }
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(MoveActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
