...
import com.onynet.a30home.activity.QueryActivity1;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    @BindView(R.id.main_ll_operate)
    LinearLayout mainLlOperate;
    ...
    private void initViews() {
        ...
        mainLlOperate.setVisibility(View.GONE);
    ...
    private void setActionBar() {
        ...
        toolbarTvTitle.setText(getResources().getString(R.string.app_name));
        /*显示Home图标*/
    ...
    private void setListener() {
        ...
        banner.setOnBannerClickListener(new OnBannerClickListener() {
            ...
            public void OnBannerClick(int position) {
                Intent intent = new Intent(MainActivity2.this, BannerActivity.class);
    ...
    @OnClick({R.id.main_iv_scan, R.id.main_btn_query, R.id.main_ll_batch_put, R.id.main_rl_msg})
...
//                startActivityForResult(intent, REQUEST_IMAGE);
            ...
            case R.id.main_rl_msg://消息
                startActivity(new Intent(MainActivity2.this, MsgActivity.class));
                break;
        }
    }
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(MainActivity2.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
                ...
                try {
                    CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(this, uri), new CodeUtils.AnalyzeCallback() {
                        ...
                        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
                            Toast.makeText(MainActivity2.this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                            mainEtScan.setText(result);
                        }
            ...
            public void onUsage(String result) {
                try {
                    ...
                    if (object.getInt("code") == 200) {
                        ...
                        Toast.makeText(MainActivity2.this, object.getString("msg"), Toast.LENGTH_SHORT).show();
                    }
